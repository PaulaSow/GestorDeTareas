...
public class DAOTarea {
	...
	public void insertarTarea(Tarea t) throws SQLException {
		PreparedStatement ps = (PreparedStatement) con.prepareStatement("INSERT INTO tablaTareas (titulo, descripcion, categoria,"
	...
	public ArrayList<Tarea> listaTareas() throws SQLException {
		...
		PreparedStatement ps = (PreparedStatement) con.prepareStatement("SELECT * FROM tablaTareas");
		ResultSet rs = ps.executeQuery();
			
		while (rs.next()) {
			Tarea t = new Tarea (rs.getInt(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getInt(5),
	...
	public Tarea buscarID(int id) throws SQLException {
		PreparedStatement ps = (PreparedStatement) con.prepareStatement("SELECT * FROM tablaTareas WHERE id = ?");
		ps.setInt(1, id);
		ResultSet rs = ps.executeQuery();
		Tarea result = null;
	...
	public void update(Tarea t) throws SQLException {
		PreparedStatement ps = (PreparedStatement) con.prepareStatement("UPDATE tablaTareas SET titulo = ?, descripcion = ?,"
	...
	public void delete(int id) throws SQLException {
		...
		PreparedStatement ps = (PreparedStatement) con.prepareStatement("DELETE FROM tablaTareas WHERE id = ?");
		ps.setInt(1, id);
		ps.executeUpdate();
		ps.close();
	}
